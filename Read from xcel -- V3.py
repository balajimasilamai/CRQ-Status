...
delete_row1=[]
def read_execl():
     book=xlrd.open_workbook('CRQ Status.xls', on_demand = True)
     ...
     delete_row2=[]
     print ('length of deleterow ',len(delete_row))
     row=[]
...
while start:
     ...
     if len(r_list)> 0:
       ...
       for i in range(0,1,1):              
          filename='D:/Python/Automation tool/CRQ Status/CRQ for  all Status/Without HTML/New Features/Code/Deleet the duplicate record/CRQ Status.xls'
